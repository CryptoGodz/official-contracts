...
import "../../V2/CryptoGodz/ICryptoGodzTimelockVaultV2.sol";

/**
 * @title CryptoGodz Presale V5
 */
contract CryptoGodzPresaleV5 is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
     ...
     */
    event TokensPurchased(bytes32 indexed txHash, address indexed purchaser, address indexed beneficiary, uint256 value, uint256 amount);
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        ...
        emit TokensPurchased(blockhash(block.number), _msgSender(), beneficiary, weiAmount, tokens);
